...
<!--<link rel="canonical" href="www.skbmart.com" />-->
<?php } ?>
<?php if ($keywords) { ?>
...
$(function() {
    ...
    b.bind("mouseenter", function() {
        var a = $(this);
        a.addClass("slided selected");
        a.children("div").css("z-index", "9999").stop(true, true).slideDown(200, function() {
            b.not(".slided").children("div").hide();
            a.removeClass("slided");
        });
    }).bind("mouseleave", function() {
        var a = $(this);
        a.removeClass("selected").children("div").css("z-index", "1");
    });
    a.bind("mouseenter", function() {
        var a = $(this);
        c.stop(true, true).fadeTo(200, .6);
        a.addClass("hovered");
    }).bind("mouseleave", function() {
        var a = $(this);
        a.removeClass("hovered");
        c.stop(true, true).fadeTo(200, 0);
        b.children("div").hide();
    });
});
...
<div class="oe_wrapper">
    ...
    <li><a href="http://www.skbmart.com/electronics-1">Electronics</a>
        ...
        <img src="http://www.skbmart.com/image/Electronic-products-banner.jpg" style="float: right;margin-right: 5px;width: 248px;  border:1px solid #c0c0c0;position: fixed;margin-top: 35px;"> </div>
            </li>
    <li><a href="http://www.skbmart.com/watches-7">Watches</a>
        ...
        <img src="http://www.skbmart.com/image/titanraga.jpg" style="margin-right: -26px;width: 238px; border:1px solid #c0c0c0;"/> <img src="http://www.skbmart.com/image/unisexwatches.jpg" style="float: right;margin-right: -20px;width: 238px; border:1px solid #c0c0c0;"/> <img src="http://www.skbmart.com/image/upto25offcasio.png" style="float: right;margin-right: 2px;width: 238px; border:1px solid #c0c0c0;"/> </div>
            </li>
    <li style="line-height:10px;"><a href="http://www.skbmart.com/home-and-kitchen-appliances-3">Home & Kitchen Appliances</a>
        ...
        <img src="http://www.skbmart.com/image/home-and-kitchen-appliances-img.jpg" style="float: right;margin-right: -13px;width: 308px;margin-top: -16px; border:1px solid #c0c0c0;"/> </div>
            </li>
    <li><a href="http://www.skbmart.com/apparel-4">Apparel</a>
        ...
        <img src="http://www.skbmart.com/image/women-clothing-img.jpg" style="float: right;margin-right: 5px;width: 355px;  border:1px solid #c0c0c0;"/> </div>
            </li>
    <li style="line-height:10px;"><a href="http://www.skbmart.com/beauty-and-personal-care-5">Beauty & Personal Care</a>
        ...
        <img src="http://www.skbmart.com/image/beautypersonalcare.jpg" style="float: right;width: 81%;  border:1px solid #c0c0c0;margin-top: -187px;"/> </div>
            </li>
    <li><a href="http://www.skbmart.com/fashion-accessories-6">Fashion </a>
        ...
        <ul style="width: 178px;">
                  <li class="oe_heading"><a href="http://www.skbmart.com/fashion-accessories-6/for-men-139">Mens Footwear</a></li>
                  <li> <a href="http://www.skbmart.com/fashion-accessories-6/for-men-139/casual--185">Casual</a> </li>
                  <li> <a href="http://www.skbmart.com/fashion-accessories-6/for-men-139/formals--183">Formals</a> </li>
                  <li> <a href="http://www.skbmart.com/fashion-accessories-6/for-men-139/loafers--187">Loafers</a> </li>
                  <li> <a href="http://www.skbmart.com/fashion-accessories-6/for-men-139/boots--188">Boots</a> </li>
                  <li> <a href="http://www.skbmart.com/fashion-accessories-6/for-men-139/sports-shoes--184">Sports Shoes</a> </li>
                </ul>
        <ul style="width: 178px;">
                  <li class="oe_heading"><a href="http://www.skbmart.com/fashion-accessories-6/for-women-140">Womens Footwear</a></li>
                  <li> <a href="http://www.skbmart.com/fashion-accessories-6/for-women-140/ethnic--191">Ethnic</a></li>
                  <li> <a href="http://www.skbmart.com/fashion-accessories-6/for-women-140/formals--189">Formals</a></li>
                  <li> <a href="http://www.skbmart.com/fashion-accessories-6/for-women-140/sports-shoes--190">Sports Shoes</a></li>
                  <li> <a href="http://www.skbmart.com/fashion-accessories-6/for-women-140/unisex-142">Unisex</a></li>
                </ul>
        <img src="http://www.skbmart.com/image/fashion-banner.jpg"  style="border: 1px solid #c0c0c0;margin-top: 20px;"> </div>
            </li>
    <li><a href="http://www.skbmart.com/mobiles---accessories-2/mobile---accessories">Mobiles</a>
        ...
        <img src="http://www.skbmart.com/image/mobile-accessories-banner.jpg" style="float: right;width: 81%;  border:1px solid #c0c0c0;margin-top: -136px;"> </div>
            </li>
    <li><a href="http://www.skbmart.com/lifestyle-8">Lifestyle</a>
        ...
        <img src="http://www.skbmart.com/image/lifestyle.jpg" style="float: right;margin-right: -12px;width: 774px;  border:1px solid #c0c0c0;margin-top: -125px;"> </div>
            </li>
    <li><a href="http://www.skbmart.com/computer-9">Computer </a>
        ...
        <img src="http://www.skbmart.com/image/computer-accessories-banenr.jpg" style="float: right;margin-right: -12px;width: 357px;  border:1px solid #c0c0c0;margin-top: -12px;"> </div>
            </li>
  </ul>
        </div>
