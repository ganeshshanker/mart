<form action="<?php echo $action; ?>" method="post">
  ...
  <input type="hidden" name="txtTranID" value="<?php echo $cart_order_id; ?>" />
<?php if($demo) { ?>
  <input type="hidden" name="txtMarketCode" value="<?php echo $testid; ?>" />
<?php } else { ?>
  <input type="hidden" name="txtMarketCode" value="<?php echo $liveid; ?>" />
<?php } ?>
  <input type="hidden" name="txtAcctNo" value="1" />  <input type="hidden" name="txtTxnAmount" value="<?php echo $total; ?>" />
  <input type="hidden" name="txtCheckSumKey" value="<?php echo $secret; ?>" />
  <input type="hidden" name="txtBankCode" value="<?php echo $bank; ?>" />
  <input type="text" name="txtResponseURL" value="<?php echo $responseurl; ?>" />
