		...
		<footer id="footend" class="container">
			...
			<?php if($this->config->get('funkeal_status')== 1) { ?>
				...
				<?php } else { ?>
					...
					<div id="copy"><?php echo $this->config->get('config_name'); ?> &copy;<?php echo date('Y'); ?>. All rights reserved.<br/>
					        Website developed, hosted and maintained by: <a style="text-decoration: none;" href="http://www.smookyweb.com" target="_blank"><b style="color: #959737;">Smooky</b><b style="color: #555555;"> Web</b></a><br><br>
					</div>
				<?php } ?>
			<?php } else { ?>
					<div id="copy"><?php echo $this->config->get('config_name'); ?> &copy;<?php echo date('Y'); ?>. All rights reserved.<br/>
