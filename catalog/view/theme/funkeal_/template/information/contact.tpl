...
<div id="content"><?php echo $content_top; ?>
  ...
  <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
	...
	Phone: +91 (11) 25214532<br /><br />
	Email: <a href="mailto:support@skbmart.com">support@skbmart.com</a><br />
	<a href="mailto:skbmartindia@gmail.com">skbmartindia@gmail.com</a><br />
        <?php //echo $store; ?><br />
        <?php //echo $address; ?>
      </div>
      <div class="right">
